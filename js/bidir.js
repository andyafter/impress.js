...
var formatNumber = function (d) {
  ...
  return "$" + numberFormat(d) +" mSGD";
},

formatFlow = function (d) {
  var flowFormat = d3.format(",.0f"); // zero decimal places with sign
  return "$" + flowFormat(Math.abs(d)) + (d < 0 ? " mSGD" : " mSGD");
},
...
svg = d3.select("#bidirchart").append("svg")
...
tooltip = d3.select("#bidirchart").append("div").attr("id", "tooltip");
...
var exampleLinks = [
  {"source":8,"target":28,"value":52},
  {"source":17,"target":18,"value":100},
  {"source":22,"target":24,"value":37},
  {"source":3,"target":13,"value":13},
  {"source":24,"target":24,"value":38},
  {"source":5,"target":4,"value":44},
  {"source":15,"target":5,"value":46},
  {"source":18,"target":8,"value":92},
  {"source":3,"target":20,"value":47},
  {"source":17,"target":18,"value":35},
  {"source":22,"target":5,"value":31},
  {"source":4,"target":24,"value":59},
  {"source":26,"target":16,"value":57},
  {"source":27,"target":6,"value":75},
  {"source":23,"target":4,"value":23},
  {"source":10,"target":24,"value":5},
  {"source":17,"target":16,"value":13},
  {"source":5,"target":12,"value":53},
  {"source":12,"target":16,"value":87},
  {"source":19,"target":5,"value":15},
  {"source":15,"target":24,"value":54},
  {"source":27,"target":2,"value":12},
  {"source":26,"target":28,"value":4},
  {"source":22,"target":24,"value":179},
  {"source":3,"target":18,"value":89},
  {"source":18,"target":5,"value":143},
  {"source":25,"target":28,"value":70},
  {"source":12,"target":1,"value":226},
  {"source":28,"target":21,"value":417},
  {"source":9,"target":16,"value":85},
  {"source":14,"target":23,"value":84},
  {"source":6,"target":1,"value":16},
  {"source":9,"target":15,"value":2},
  {"source":16,"target":24,"value":19},
  {"source":22,"target":28,"value":112},
  {"source":8,"target":21,"value":288},
  {"source":22,"target":7,"value":97},
  {"source":18,"target":10,"value":371},
  {"source":"eq","target":1,"value":477},
  {"source":1,"target":21,"value":174},
  {"source":1,"target":24,"value":436},
  {"source":17,"target":1,"value":216}
]
